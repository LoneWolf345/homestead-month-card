...
- **The month grid** (Sunday first). Every cell carries the big Fraunces day number and the paper-calendar **day-of-year agate** (`250/115` — day of year / days remaining).
